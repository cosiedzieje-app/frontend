<template>
    ...
    :class="{
        ...
        <span class="text-xs cursor-pointer hover:underline" title="Pokaż na mapie" @click.stop.stop="markerClicked"><font-awesome-icon class="mr-1" icon="fa-solid fa-location-dot" />{{ marker.address.city }}, ul. {{  marker.address.street }} {{  marker.address.number }}</span>
    </div>
</template>
